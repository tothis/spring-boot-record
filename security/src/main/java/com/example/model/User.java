...
public class User extends BaseEntity implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        ...
        roleList.forEach(role -> grantedAuthorities.add(new SimpleGrantedAuthority("ROLE_" + role.getRoleName())));
    ...
    public boolean isAccountNonLocked() {
        // 用户是否未锁定
        return !this.getState().equals((byte) 2);
    }
    ...
    public boolean isEnabled() {
        // 用户是否启用
        return this.getState().equals((byte) 0);
    }
}