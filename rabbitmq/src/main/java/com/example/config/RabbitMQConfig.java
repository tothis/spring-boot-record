...
public class RabbitMQConfig {
    ...
    public static final String ROUTINGKEY_B = "routing-key-B";
    public static final String ROUTINGKEY_C = "routing-key-C";
     ...
     * 1. 设置交换机类型
     * 2. 将队列绑定到交换机
     * FanoutExchange将消息分发到所有的绑定队列 无routingkey的概念
